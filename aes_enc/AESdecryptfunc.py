...
def shiftrow(temp2):
    if len(temp2) == 8:
        ...
        temp3 = temp2[0] + temp2[1] + temp2[10] + temp2[11] + temp2[20] + temp2[21] + temp2[30] + temp2[31] + temp2[8] \
                + temp2[9] + temp2[18] + temp2[19] + temp2[28] + temp2[29] + temp2[6] + temp2[7] + temp2[16] + \
                temp2[17] + temp2[26] + temp2[27] + temp2[4] + temp2[5] + temp2[14] + temp2[15] + temp2[24] + \
                temp2[25] + temp2[2] + temp2[3] + temp2[12] + temp2[13] + temp2[22] + temp2[23]
        return temp3
...
def invshiftrow(temp2):
    if len(temp2) == 8:
        ...
        temp3 = temp2[0] + temp2[1] + temp2[26] + temp2[27] + temp2[20] + temp2[21] + temp2[14] + temp2[15] + temp2[8] \
                + temp2[9] + temp2[2] + temp2[3] + temp2[28] + temp2[29] + temp2[22] + temp2[23] + temp2[16] + \
                temp2[17] + temp2[10] + temp2[11] + temp2[4] + temp2[5] + temp2[30] + temp2[31] + temp2[24] + temp2[25] \
                + temp2[18] + temp2[19] + temp2[12] + temp2[13] + temp2[6] + temp2[7]
...
def invsubbyte(myhexstring):
    loop2 = 0
    temp2 = ""
    part0 = ['52', '09', '6a', 'd5', '30', '36', 'a5', '38', 'bf', '40', 'a3', '9e', '81', 'f3', 'd7',
             'fb']
    part1 = ['7c', 'e3', '39', '82', '9b', '2f', 'ff', '87', '34', '8e', '43', '44', 'c4', 'de', 'e9',
             'cb']
    part2 = ['54', '7b', '94', '32', 'a6', 'c2', '23', '3d', 'ee', '4c', '95', '0b', '42', 'fa', 'c3',
             '4e']
    part3 = ['08', '2e', 'a1', '66', '28', 'd9', '24', 'b2', '76', '5b', 'a2', '49', '6d', '8b', 'd1',
             '25']
    part4 = ['72', 'f8', 'f6', '64', '86', '68', '98', '16', 'd4', 'a4', '5c', 'cc', '5d', '65', 'b6',
             '92']
    part5 = ['6c', '70', '48', '50', 'fd', 'ed', 'b9', 'da', '5e', '15', '46', '57', 'a7', '8d', '9d',
             '84']
    part6 = ['90', 'd8', 'ab', '00', '8c', 'bc', 'd3', '0a', 'f7', 'e4', '58', '05', 'b8', 'b3', '45',
             '06']
    part7 = ['d0', '2c', '1e', '8f', 'ca', '3f', '0f', '02', 'c1', 'af', 'bd', '03', '01', '13', '8a',
             '6b']
    part8 = ['3a', '91', '11', '41', '4f', '67', 'dc', 'ea', '97', 'f2', 'cf', 'ce', 'f0', 'b4', 'e6',
             '73']
    part9 = ['96', 'ac', '74', '22', 'e7', 'ad', '35', '85', 'e2', 'f9', '37', 'e8', '1c', '75', 'df',
             '6e']
    part10 = ['47', 'f1', '1a', '71', '1d', '29', 'c5', '89', '6f', 'b7', '62', '0e', 'aa', '18', 'be',
              '1b']
    part11 = ['fc', '56', '3e', '4b', 'c6', 'd2', '79', '20', '9a', 'db', 'c0', 'fe', '78', 'cd', '5a',
              'f4']
    part12 = ['1f', 'dd', 'a8', '33', '88', '07', 'c7', '31', 'b1', '12', '10', '59', '27', '80', 'ec',
              '5f']
    part13 = ['60', '51', '7f', 'a9', '19', 'b5', '4a', '0d', '2d', 'e5', '7a', '9f', '93', 'c9', '9c',
              'ef']
    part14 = ['a0', 'e0', '3b', '4d', 'ae', '2a', 'f5', 'b0', 'c8', 'eb', 'bb', '3c', '83', '53', '99',
              '61']
    part15 = ['17', '2b', '04', '7e', 'ba', '77', 'd6', '26', 'e1', '69', '14', '63', '55', '21', '0c',
              '7d']
...
def invmixcolumn(bv3):
    ...
    tempbv1 = bv01.gf_multiply_modular(fourteen, eightlim, 8)
    ...
    tempbv1 = bv01.gf_multiply_modular(nine, eightlim, 8)
    ...
    tempbv1 = bv01.gf_multiply_modular(thirteen, eightlim, 8)
    ...
    tempbv1 = bv01.gf_multiply_modular(eleven, eightlim, 8)
    ...
    tempbv1 = bv89.gf_multiply_modular(fourteen, eightlim, 8)
    ...
    tempbv1 = bv89.gf_multiply_modular(nine, eightlim, 8)
    ...
    tempbv1 = bv89.gf_multiply_modular(thirteen, eightlim, 8)
    ...
    tempbv1 = bv89.gf_multiply_modular(eleven, eightlim, 8)
    ...
    tempbv1 = bv1617.gf_multiply_modular(fourteen, eightlim, 8)
    ...
    tempbv1 = bv1617.gf_multiply_modular(nine, eightlim, 8)
    ...
    tempbv1 = bv1617.gf_multiply_modular(thirteen, eightlim, 8)
    ...
    tempbv1 = bv1617.gf_multiply_modular(eleven, eightlim, 8)
    ...
    tempbv1 = bv2425.gf_multiply_modular(fourteen, eightlim, 8)
    ...
    tempbv1 = bv2425.gf_multiply_modular(nine, eightlim, 8)
    ...
    tempbv1 = bv2425.gf_multiply_modular(thirteen, eightlim, 8)
    ...
    tempbv1 = bv2425.gf_multiply_modular(eleven, eightlim, 8)
    ...
    newbv = newbv01 + newbv23 + newbv45 + newbv67 + newbv89 + newbv1011 + newbv1213 + newbv1415 + newbv1617 + \
